...
*/
	...
	echo 'Users
		...
		<p><input type="submit" value="add mobtype" name="extral" class="extral"
		onClick="location.href=\'add.php?table=mobtypes\'" />
		<input type="submit" value="mobtype list" name="extral" class="extral"
		onClick="location.href=\'list.php?table=mobtypes\'" />
		<input type="submit" value="add mob" name="extra" class="extra"
		onClick="location.href=\'add.php?table=mobs\'" />
		<input type="submit" value="mob list" name="extra" class="extra"
		onClick="location.href=\'list.php?table=mobs\'" /></p>
		<p><input type="submit" value="add drop" name="extra" class="extra"
		...
		<input type="submit" value="add mapmob" name="extra" class="extra"
		...
		<input type="submit" value="add npcquest" name="extral" class="extral"
		...
		<p><input type="submit" value="add mapnpc" name="extra" class="extra"
