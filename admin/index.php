...
*/
	...
	echo '<p><input type="submit" value="user list" name="extra" class="extra"
		...
		<p><input type="submit" value="add spell to char" name="extral" class="extral"
		...
		<p><input type="submit" value="add npc to map" name="extral" class="extral"
		...
		<p><input type="submit" value="add mob to map" name="extral" class="extral"
		...
		<p><input type="submit" value="add quest to npc" name="extral" class="extral"
